...
export class CreateTestData1732280885581 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        ("name", logo, description, telegram, phone, email, membership_fee)
        VALUES('Aalto Salsa Society', 'https://www.ayy.fi/sites/g/files/flghsv231/files/styles/o_690w_ah_n/public/2024-09/Aalto_Salsa_Society.png?itok=rkpOM-wy', 'The Aalto Salsa Society is a welcoming community of Latin dance enthusiasts! We teach Salsa and Bachata classes and organize various events throughout the year. 
        ...
        INSERT INTO public.association
        ("name", logo, description, telegram, phone, email, membership_fee)
        VALUES('Aalto University''s Mechatronics Club (AMEK)', 'https://www.ayy.fi/sites/g/files/flghsv231/files/styles/o_690w_ah_n/public/2024-09/AMEK.png?itok=wiRfTL6l', 'AMEK is a professional association for students interested in mechatronics, located in Otaniemi, Espoo. The association''s activities are managed by a board composed of students from Aalto University.
        ...
        INSERT INTO public.association
        ("name", logo, description, telegram, phone, email, membership_fee)
        VALUES('Otanko ry', 'https://www.ayy.fi/sites/g/files/flghsv231/files/styles/o_690w_ah_n/public/2023-11/Otanko.png?itok=ecNfriOr', 'Are you tired of the same old gym routine and looking for a fun and unique way to sculpt your body by getting impressive biceps and a stunning six-pack?
        ...
        INSERT INTO public.association
        ("name", logo, description, telegram, phone, email, membership_fee)
        VALUES('Aalto Beer Pong', 'https://www.ayy.fi/sites/g/files/flghsv231/files/styles/o_690w_ah_n/public/2019-05/aalto_beer_pong_logo.png?itok=5cvvpBqv', 'Aalto Beer Pong was founded in December 2011. The main objective of the association is to promote the Beer Pong better known in Finland. Aalto Beer Pong is a non-profit association.
        ...
        INSERT INTO public.association
        ("name", logo, description, telegram, phone, email, membership_fee)
        VALUES('Otakut', 'https://www.ayy.fi/sites/g/files/flghsv231/files/styles/o_690w_ah_n/public/2024-07/Otakut-Logo-2013%20%281%29.png?itok=WW8Q-zwZ', 'Otakut is an anime club in Espoo, affiliated with Aalto University''s Student Union since May 1996. We support hobbies related to Japanese animated movies, series and comics.
        ...
        INSERT INTO public.association
        ("name", logo, description, telegram, phone, email, membership_fee)
        VALUES('Aalto-Basket', 'https://www.ayy.fi/sites/g/files/flghsv231/files/styles/o_690w_ah_n/public/2019-05/aaltobasket_logo.png?itok=dGaniM1S', 'Aalto-Basket is the basketball team of Aalto University from Espoo.
      ...
      public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        DELETE FROM public."event" WHERE name='Salsa class';
        DELETE FROM public."event" WHERE name='Let''s play basketball!';
        DELETE FROM public."event" WHERE name='Anime night @ JMT 1';
        DELETE FROM public."event" WHERE name='Forest adventures';
        DELETE FROM public."event" WHERE name='Pole dance for beginners';
        DELETE FROM public."event" WHERE name='Steamy Sauna Sunday';
        DELETE FROM public."event" WHERE name='Mahjong night';
        DELETE FROM public."event" WHERE name='Hike @ Nuuksio National Park';
        DELETE FROM public."event" WHERE name='Beer Pong Afterparty';
        DELETE FROM public."event" WHERE name='Let''s fix stuff together!';
        `);
      }
}
